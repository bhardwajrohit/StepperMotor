...
const Field_t TIM2_CCMR1_Output_fields[] = {
   ...
   { "\x3c\x37\x43\x14", 15, 1 },  /* OC2CE: Output compare 2 clear
              enable */
   { "\x3c\x37\x0d\x95\xe0", 16, 1 },  /* OC1M_3: Output compare 1 mode bit
              3 */
   { "\x3c\x37\x4d\x95\xe0", 24, 1 },  /* OC2M_3: Output compare 2 mode bit
              3 */
};
...
const Field_t TIM2_CCMR2_Output_fields[] = {
   ...
   { "\x3d\xd7\xc3\x14", 15, 1 },  /* O24CE: Output compare 4 clear
              enable */
...
const Field_t TIM2_CCER_fields[] = {
   ...
   { "\x0c\x37\xd0", 13, 1 },  /* CC4P: Capture/Compare 3 output
              Polarity */
   { "\x0c\x37\xce\x40", 15, 1 },  /* CC4NP: Capture/Compare 3 output
              Polarity */
};
...
const Field_t TIM2_CNT_fields[] = {
   ...
   { "\x0c\xe5\x25\x3d\x29\x55\x24\x60\xd0\x64", 31, 1 },  /* CNT_or_UIFCPY: if IUFREMAP=0 than CNT with read write
...
const Field_t TIM2_CCR1_fields[] = {
   { "\x0c\x34\x9c\x30", 0, 16 },  /* CCR1L: Low Capture/Compare 1
              value */
   { "\x0c\x34\x9c\x20", 16, 16 },  /* CCR1H: High Capture/Compare 1 value (on
              TIM2) */
};

const Field_t TIM2_CCR2_fields[] = {
   { "\x0c\x34\x9d\x30", 0, 16 },  /* CCR2L: Low Capture/Compare 2
              value */
   { "\x0c\x34\x9d\x20", 16, 16 },  /* CCR2H: High Capture/Compare 2 value (on
              TIM2) */
};

const Field_t TIM2_CCR3_fields[] = {
   { "\x0c\x34\x9e\x30", 0, 16 },  /* CCR3L: Low Capture/Compare value */
   { "\x0c\x34\x9e\x20", 16, 16 },  /* CCR3H: High Capture/Compare value (on
              TIM2) */
};

const Field_t TIM2_CCR4_fields[] = {
   { "\x0c\x34\x9f\x30", 0, 16 },  /* CCR4L: Low Capture/Compare value */
   { "\x0c\x34\x9f\x20", 16, 16 },  /* CCR4H: High Capture/Compare value (on
              TIM2) */
};
...
const Register_t TIM2_registers[] = {
   ...
   {"\x0c\x33\x52\x72\x53\xd5\x51\x05\x54", 24, 32, 0, TIM2_CCMR1_Output_fields, 12}, /* CCMR1_Output: capture/compare mode register 1 (output
          mode) */
   ...
   {"\x0c\x33\x52\x76\x52\x4e\x41\x55\x00", 28, 32, 0, TIM2_CCMR2_Input_fields, 6}, /* CCMR2_Input: capture/compare mode register 2 (input
          mode) */
   {"\x0c\x33\x52\x76\x53\xd5\x51\x05\x54", 28, 32, 0, TIM2_CCMR2_Output_fields, 12}, /* CCMR2_Output: capture/compare mode register 2 (output
          mode) */
...
const Register_t RTC_registers[] = {
   ...
   {"\x50\x11\x83\x48", 64, 32, 0, RTC_TAFCR_fields, 18}, /* TAFCR: tamper and alternate function configuration
          register */
...
const Field_t I2C1_CR2_fields[] = {
   { "\x4c\x11\x04\x6c", 0, 1 },  /* SADD0: Slave address bit 0 (master
              mode) */
   { "\x4c\x11\x04\x70", 1, 7 },  /* SADD1: Slave address bit 7:1 (master
              mode) */
   { "\x4c\x11\x04\x8c", 8, 2 },  /* SADD8: Slave address bit 9:8 (master
              mode) */
...
const Field_t CAN_FFA1R_fields[] = {
   { "\x18\x60\x5b", 0, 1 },  /* FFA0: Filter FIFO assignment for filter
              0 */
   { "\x18\x60\x5c", 1, 1 },  /* FFA1: Filter FIFO assignment for filter
              1 */
   { "\x18\x60\x5d", 2, 1 },  /* FFA2: Filter FIFO assignment for filter
              2 */
   { "\x18\x60\x5e", 3, 1 },  /* FFA3: Filter FIFO assignment for filter
              3 */
   { "\x18\x60\x5f", 4, 1 },  /* FFA4: Filter FIFO assignment for filter
              4 */
   { "\x18\x60\x60", 5, 1 },  /* FFA5: Filter FIFO assignment for filter
              5 */
   { "\x18\x60\x61", 6, 1 },  /* FFA6: Filter FIFO assignment for filter
              6 */
   { "\x18\x60\x62", 7, 1 },  /* FFA7: Filter FIFO assignment for filter
              7 */
   { "\x18\x60\x63", 8, 1 },  /* FFA8: Filter FIFO assignment for filter
              8 */
   { "\x18\x60\x64", 9, 1 },  /* FFA9: Filter FIFO assignment for filter
              9 */
   { "\x18\x60\x5c\x6c", 10, 1 },  /* FFA10: Filter FIFO assignment for filter
              10 */
   { "\x18\x60\x5c\x70", 11, 1 },  /* FFA11: Filter FIFO assignment for filter
              11 */
   { "\x18\x60\x5c\x74", 12, 1 },  /* FFA12: Filter FIFO assignment for filter
              12 */
   { "\x18\x60\x5c\x78", 13, 1 },  /* FFA13: Filter FIFO assignment for filter
              13 */
   { "\x18\x60\x5c\x7c", 14, 1 },  /* FFA14: Filter FIFO assignment for filter
              14 */
   { "\x18\x60\x5c\x80", 15, 1 },  /* FFA15: Filter FIFO assignment for filter
              15 */
   { "\x18\x60\x5c\x84", 16, 1 },  /* FFA16: Filter FIFO assignment for filter
              16 */
   { "\x18\x60\x5c\x88", 17, 1 },  /* FFA17: Filter FIFO assignment for filter
              17 */
   { "\x18\x60\x5c\x8c", 18, 1 },  /* FFA18: Filter FIFO assignment for filter
              18 */
   { "\x18\x60\x5c\x90", 19, 1 },  /* FFA19: Filter FIFO assignment for filter
              19 */
   { "\x18\x60\x5d\x6c", 20, 1 },  /* FFA20: Filter FIFO assignment for filter
              20 */
   { "\x18\x60\x5d\x70", 21, 1 },  /* FFA21: Filter FIFO assignment for filter
              21 */
   { "\x18\x60\x5d\x74", 22, 1 },  /* FFA22: Filter FIFO assignment for filter
              22 */
   { "\x18\x60\x5d\x78", 23, 1 },  /* FFA23: Filter FIFO assignment for filter
              23 */
   { "\x18\x60\x5d\x7c", 24, 1 },  /* FFA24: Filter FIFO assignment for filter
              24 */
   { "\x18\x60\x5d\x80", 25, 1 },  /* FFA25: Filter FIFO assignment for filter
              25 */
   { "\x18\x60\x5d\x84", 26, 1 },  /* FFA26: Filter FIFO assignment for filter
              26 */
   { "\x18\x60\x5d\x88", 27, 1 },  /* FFA27: Filter FIFO assignment for filter
              27 */
};
...
const Register_t CAN_registers[] = {
   ...
   {"\x50\x45\x1b\x48", 388, 32, 0, CAN_TDT0R_fields, 3}, /* TDT0R: mailbox data length control and time stamp
          register */
   ...
   {"\x50\x45\x1c\x48", 404, 32, 0, CAN_TDT1R_fields, 3}, /* TDT1R: mailbox data length control and time stamp
          register */
   ...
   {"\x50\x45\x1d\x48", 420, 32, 0, CAN_TDT2R_fields, 3}, /* TDT2R: mailbox data length control and time stamp
          register */
   ...
   {"\x48\x96\xd2", 432, 32, 0, CAN_RI0R_fields, 4}, /* RI0R: receive FIFO mailbox identifier
          register */
   {"\x48\x45\x1b\x48", 436, 32, 0, CAN_RDT0R_fields, 3}, /* RDT0R: receive FIFO mailbox data length control and
          time stamp register */
   {"\x48\x43\x1b\x48", 440, 32, 0, CAN_RDL0R_fields, 4}, /* RDL0R: receive FIFO mailbox data low
          register */
   {"\x48\x42\x1b\x48", 444, 32, 0, CAN_RDH0R_fields, 4}, /* RDH0R: receive FIFO mailbox data high
          register */
   {"\x48\x97\x12", 448, 32, 0, CAN_RI1R_fields, 4}, /* RI1R: receive FIFO mailbox identifier
          register */
   {"\x48\x45\x1c\x48", 452, 32, 0, CAN_RDT1R_fields, 3}, /* RDT1R: receive FIFO mailbox data length control and
          time stamp register */
   {"\x48\x43\x1c\x48", 456, 32, 0, CAN_RDL1R_fields, 4}, /* RDL1R: receive FIFO mailbox data low
          register */
   {"\x48\x42\x1c\x48", 460, 32, 0, CAN_RDH1R_fields, 4}, /* RDH1R: receive FIFO mailbox data high
          register */
   ...
   {"\x18\x60\x5c\x48", 532, 32, 0, CAN_FFA1R_fields, 28}, /* FFA1R: filter FIFO assignment
          register */
...
const Field_t DAC_CR_fields[] = {
   ...
   { "\x08\xf1\x86\x70", 1, 1 },  /* BOFF1: DAC channel1 output buffer
              disable */
   ...
   { "\x08\xf1\x86\x74", 17, 1 },  /* BOFF2: DAC channel2 output buffer
              disable */
...
const Register_t DAC_registers[] = {
   ...
   {"\x10\x84\x9c\x75\x27\x00", 8, 32, 0, DAC_DHR12R1_fields, 1}, /* DHR12R1: channel1 12-bit right-aligned data holding
          register */
   {"\x10\x84\x9c\x74\xc7\x00", 12, 32, 0, DAC_DHR12L1_fields, 1}, /* DHR12L1: channel1 12-bit left aligned data holding
          register */
   {"\x10\x84\xa3\x49\xc0", 16, 32, 0, DAC_DHR8R1_fields, 1}, /* DHR8R1: channel1 8-bit right aligned data holding
          register */
   {"\x10\x84\x9c\x75\x27\x40", 20, 32, 0, DAC_DHR12R2_fields, 1}, /* DHR12R2: channel2 12-bit right aligned data holding
          register */
   {"\x10\x84\x9c\x74\xc7\x40", 24, 32, 0, DAC_DHR12L2_fields, 1}, /* DHR12L2: channel2 12-bit left aligned data holding
          register */
   {"\x10\x84\xa3\x49\xd0", 28, 32, 0, DAC_DHR8R2_fields, 1}, /* DHR8R2: channel2 8-bit right-aligned data holding
          register */
   {"\x10\x84\x9c\x75\x21\x00", 32, 32, 0, DAC_DHR12RD_fields, 2}, /* DHR12RD: Dual DAC 12-bit right-aligned data holding
          register */
   {"\x10\x84\x9c\x74\xc1\x00", 36, 32, 0, DAC_DHR12LD_fields, 2}, /* DHR12LD: DUAL DAC 12-bit left aligned data holding
          register */
   {"\x10\x84\xa3\x48\x40", 40, 32, 0, DAC_DHR8RD_fields, 2}, /* DHR8RD: DUAL DAC 8-bit right aligned data holding
          register */
...
const Field_t SYSCFG_CFGR1_fields[] = {
   { "\x34\x53\x65\x34\xf1\x05", 0, 2 },  /* MEM_MODE: Memory mapping selection
              bits */
   ...
   { "\x10\x10\xe5\x51\x22\x47\x95\x23\x50", 7, 1 },  /* DAC_TRIG_RMP: DAC trigger remap (when TSEL =
              001) */
   { "\x04\x40\xdd\x7e\x51\x0d\x06\x54\x8d\x40", 8, 1 },  /* ADC24_DMA_RMP: ADC24 DMA remapping bit */
   { "\x50\x93\x5c\x86\x51\x0d\x06\x54\x8d\x40", 11, 1 },  /* TIM16_DMA_RMP: TIM16 DMA request remapping
              bit */
   { "\x50\x93\x5c\x8a\x51\x0d\x06\x54\x8d\x40", 12, 1 },  /* TIM17_DMA_RMP: TIM17 DMA request remapping
              bit */
   { "\x50\x93\x61\x94\x40\x43\x72\x51\x0d\x06\x54\x8d\x40", 13, 1 },  /* TIM6_DAC1_DMA_RMP: TIM6 and DAC1 DMA request remapping
              bit */
   { "\x50\x93\x62\x94\x40\x43\x76\x51\x0d\x06\x54\x8d\x40", 14, 1 },  /* TIM7_DAC2_DMA_RMP: TIM7 and DAC2 DMA request remapping
              bit */
   { "\x25\xd0\xe5\x40\x28\x65\x18\xd0", 16, 1 },  /* I2C_PB6_FM: Fast Mode Plus (FM+) driving capability
              activation bits. */
   { "\x25\xd0\xe5\x40\x28\xa5\x18\xd0", 17, 1 },  /* I2C_PB7_FM: Fast Mode Plus (FM+) driving capability
              activation bits. */
   { "\x25\xd0\xe5\x40\x28\xe5\x18\xd0", 18, 1 },  /* I2C_PB8_FM: Fast Mode Plus (FM+) driving capability
              activation bits. */
   { "\x25\xd0\xe5\x40\x29\x25\x18\xd0", 19, 1 },  /* I2C_PB9_FM: Fast Mode Plus (FM+) driving capability
              activation bits. */
   ...
   { "\x19\x05\x65\x25\x40", 26, 6 },  /* FPU_IT: Interrupt enable bits from
              FPU */
};

const Field_t SYSCFG_RCR_fields[] = {
   { "\x40\x11\xc5\x6e\x55\xd0", 0, 1 },  /* PAGE0_WP: CCM SRAM page write protection
              bit */
   { "\x40\x11\xc5\x72\x55\xd0", 1, 1 },  /* PAGE1_WP: CCM SRAM page write protection
              bit */
   { "\x40\x11\xc5\x76\x55\xd0", 2, 1 },  /* PAGE2_WP: CCM SRAM page write protection
              bit */
   { "\x40\x11\xc5\x7a\x55\xd0", 3, 1 },  /* PAGE3_WP: CCM SRAM page write protection
              bit */
   { "\x40\x11\xc5\x7e\x55\xd0", 4, 1 },  /* PAGE4_WP: CCM SRAM page write protection
              bit */
   { "\x40\x11\xc5\x82\x55\xd0", 5, 1 },  /* PAGE5_WP: CCM SRAM page write protection
              bit */
   { "\x40\x11\xc5\x86\x55\xd0", 6, 1 },  /* PAGE6_WP: CCM SRAM page write protection
              bit */
   { "\x40\x11\xc5\x8a\x55\xd0", 7, 1 },  /* PAGE7_WP: CCM SRAM page write protection
              bit */
};
...
const Field_t SYSCFG_CFGR2_fields[] = {
   { "\x30\xf0\xd5\x42\x53\x0f\x0c\xb0", 0, 1 },  /* LOCUP_LOCK: Cortex-M0 LOCKUP bit enable
              bit */
   ...
   { "\x09\x94\x25\x04\x41\x25\x40\x14\x80", 4, 1 },  /* BYP_ADD_PAR: Bypass address bit 29 in parity
              calculation */
...
const Field_t COMP_COMP1_CSR_fields[] = {
   ...
   { "\x0c\xf3\x50\x70\x93\x93\x14\xc0", 4, 3 },  /* COMP1INSEL: Comparator 1 inverting input
              selection */
   { "\x0c\xf3\x50\x72\x53\xd5\x52\x54\xc5\x30", 10, 4 },  /* COMP1_OUT_SEL: Comparator 1 output
              selection */
   { "\x0c\xf3\x50\x71\x03\xcc", 15, 1 },  /* COMP1POL: Comparator 1 output
              polarity */
   { "\x0c\xf3\x50\x70\x86\x53\x50", 16, 2 },  /* COMP1HYST: Comparator 1 hysteresis */
   { "\x0c\xf3\x50\x72\x50\x8c\x04\xe2\xc9\x38\x70", 18, 3 },  /* COMP1_BLANKING: Comparator 1 blanking
              source */
...
const Field_t COMP_COMP2_CSR_fields[] = {
   ...
   { "\x0c\xf3\x50\x74\x93\x93\x14\xc0", 4, 3 },  /* COMP2INSEL: Comparator 2 inverting input
              selection */
   { "\x0c\xf3\x50\x74\x93\x90\x4c\x53\x00", 7, 1 },  /* COMP2INPSEL: Comparator 2 non inverted input
              selection */
   { "\x0c\xf3\x50\x74\x93\x8d\x4c\x53\x00", 9, 1 },  /* COMP2INMSEL: Comparator 1inverting input
              selection */
   { "\x0c\xf3\x50\x76\x53\xd5\x52\x54\xc5\x30", 10, 4 },  /* COMP2_OUT_SEL: Comparator 2 output
              selection */
   { "\x0c\xf3\x50\x75\x03\xcc", 15, 1 },  /* COMP2POL: Comparator 2 output
              polarity */
   { "\x0c\xf3\x50\x74\x86\x53\x50", 16, 2 },  /* COMP2HYST: Comparator 2 hysteresis */
   { "\x0c\xf3\x50\x76\x50\x8c\x04\xe2\xc9\x38\x70", 18, 3 },  /* COMP2_BLANKING: Comparator 2 blanking
              source */
   { "\x0c\xf3\x50\x74\xf5\x54", 30, 1 },  /* COMP2OUT: Comparator 2 output */
...
const Field_t COMP_COMP3_CSR_fields[] = {
   ...
   { "\x0c\xf3\x50\x78\x93\x93\x14\xc0", 4, 3 },  /* COMP3INSEL: Comparator 3 inverting input
              selection */
   { "\x0c\xf3\x50\x78\x93\x90\x4c\x53\x00", 7, 1 },  /* COMP3INPSEL: Comparator 3 non inverted input
              selection */
   { "\x0c\xf3\x50\x7a\x53\xd5\x52\x54\xc5\x30", 10, 4 },  /* COMP3_OUT_SEL: Comparator 3 output
              selection */
   { "\x0c\xf3\x50\x79\x03\xcc", 15, 1 },  /* COMP3POL: Comparator 3 output
              polarity */
   { "\x0c\xf3\x50\x78\x86\x53\x50", 16, 2 },  /* COMP3HYST: Comparator 3 hysteresis */
   { "\x0c\xf3\x50\x7a\x50\x8c\x04\xe2\xc9\x38\x70", 18, 3 },  /* COMP3_BLANKING: Comparator 3 blanking
              source */
...
const Field_t COMP_COMP4_CSR_fields[] = {
   ...
   { "\x0c\xf3\x50\x7c\x93\x93\x14\xc0", 4, 3 },  /* COMP4INSEL: Comparator 4 inverting input
              selection */
   { "\x0c\xf3\x50\x7c\x93\x90\x4c\x53\x00", 7, 1 },  /* COMP4INPSEL: Comparator 4 non inverted input
              selection */
   { "\x0c\xf3\x5f\x5c\x93\x8d\x3c\x41\x40", 9, 1 },  /* COM4WINMODE: Comparator 4 window mode */
   { "\x0c\xf3\x50\x7e\x53\xd5\x52\x54\xc5\x30", 10, 4 },  /* COMP4_OUT_SEL: Comparator 4 output
              selection */
   { "\x0c\xf3\x50\x7d\x03\xcc", 15, 1 },  /* COMP4POL: Comparator 4 output
              polarity */
   { "\x0c\xf3\x50\x7c\x86\x53\x50", 16, 2 },  /* COMP4HYST: Comparator 4 hysteresis */
   { "\x0c\xf3\x50\x7e\x50\x8c\x04\xe2\xc9\x38\x70", 18, 3 },  /* COMP4_BLANKING: Comparator 4 blanking
              source */
...
const Field_t COMP_COMP5_CSR_fields[] = {
   ...
   { "\x0c\xf3\x50\x80\x93\x93\x14\xc0", 4, 3 },  /* COMP5INSEL: Comparator 5 inverting input
              selection */
   { "\x0c\xf3\x50\x80\x93\x90\x4c\x53\x00", 7, 1 },  /* COMP5INPSEL: Comparator 5 non inverted input
              selection */
   { "\x0c\xf3\x50\x82\x53\xd5\x52\x54\xc5\x30", 10, 4 },  /* COMP5_OUT_SEL: Comparator 5 output
              selection */
   { "\x0c\xf3\x50\x81\x03\xcc", 15, 1 },  /* COMP5POL: Comparator 5 output
              polarity */
   { "\x0c\xf3\x50\x80\x86\x53\x50", 16, 2 },  /* COMP5HYST: Comparator 5 hysteresis */
   { "\x0c\xf3\x50\x82\x50\x8c\x04\xe2\xc9\x38\x70", 18, 3 },  /* COMP5_BLANKING: Comparator 5 blanking
              source */
...
const Field_t COMP_COMP6_CSR_fields[] = {
   ...
   { "\x0c\xf3\x50\x84\x93\x93\x14\xc0", 4, 3 },  /* COMP6INSEL: Comparator 6 inverting input
              selection */
   { "\x0c\xf3\x50\x84\x93\x90\x4c\x53\x00", 7, 1 },  /* COMP6INPSEL: Comparator 6 non inverted input
              selection */
   { "\x0c\xf3\x61\x5c\x93\x8d\x3c\x41\x40", 9, 1 },  /* COM6WINMODE: Comparator 6 window mode */
   { "\x0c\xf3\x50\x86\x53\xd5\x52\x54\xc5\x30", 10, 4 },  /* COMP6_OUT_SEL: Comparator 6 output
              selection */
   { "\x0c\xf3\x50\x85\x03\xcc", 15, 1 },  /* COMP6POL: Comparator 6 output
              polarity */
   { "\x0c\xf3\x50\x84\x86\x53\x50", 16, 2 },  /* COMP6HYST: Comparator 6 hysteresis */
   { "\x0c\xf3\x50\x86\x50\x8c\x04\xe2\xc9\x38\x70", 18, 3 },  /* COMP6_BLANKING: Comparator 6 blanking
              source */
...
const Field_t COMP_COMP7_CSR_fields[] = {
   ...
   { "\x0c\xf3\x50\x88\x93\x93\x14\xc0", 4, 3 },  /* COMP7INSEL: Comparator 7 inverting input
              selection */
   { "\x0c\xf3\x50\x88\x93\x90\x4c\x53\x00", 7, 1 },  /* COMP7INPSEL: Comparator 7 non inverted input
              selection */
   { "\x0c\xf3\x50\x8a\x53\xd5\x52\x54\xc5\x30", 10, 4 },  /* COMP7_OUT_SEL: Comparator 7 output
              selection */
   { "\x0c\xf3\x50\x89\x03\xcc", 15, 1 },  /* COMP7POL: Comparator 7 output
              polarity */
   { "\x0c\xf3\x50\x88\x86\x53\x50", 16, 2 },  /* COMP7HYST: Comparator 7 hysteresis */
   { "\x0c\xf3\x50\x8a\x50\x8c\x04\xe2\xc9\x38\x70", 18, 3 },  /* COMP7_BLANKING: Comparator 7 blanking
              source */
...
const Register_t COMP_registers[] = {
   ...
   {"\x0c\xf3\x50\x76\x50\xd3\x48", 4, 32, 0, COMP_COMP2_CSR_fields, 11}, /* COMP2_CSR: control and status register */
...
const Field_t OPAMP_OPAMP1_CR_fields[] = {
   ...
   { "\x59\x09\x53\x14\xc0", 2, 2 },  /* VP_SEL: OPAMP1 Non inverting input
              selection */
   { "\x58\xd9\x53\x14\xc0", 5, 2 },  /* VM_SEL: OPAMP1 inverting input
              selection */
   { "\x50\x33\x65\x14\xe0", 7, 1 },  /* TCM_EN: Timer controlled Mux mode
              enable */
   { "\x58\xd4\xe5\x4c\x53\x00", 8, 1 },  /* VMS_SEL: OPAMP1 inverting input secondary
              selection */
   { "\x59\x04\xe5\x4c\x53\x00", 9, 2 },  /* VPS_SEL: OPAMP1 Non inverting input secondary
              selection */
   ...
   { "\x51\x22\x4d\x3c\x61\x93\x15\x44\x00", 19, 5 },  /* TRIMOFFSETP: Offset trimming value
              (PMOS) */
   { "\x51\x22\x4d\x3c\x61\x93\x15\x43\x80", 24, 5 },  /* TRIMOFFSETN: Offset trimming value
              (NMOS) */
...
const Field_t OPAMP_OPAMP2_CR_fields[] = {
   ...
   { "\x18\xf4\x83\x16\x55\x90", 1, 1 },  /* FORCE_VP: FORCE_VP */
   { "\x59\x09\x53\x14\xc0", 2, 2 },  /* VP_SEL: OPAMP2 Non inverting input
              selection */
   { "\x58\xd9\x53\x14\xc0", 5, 2 },  /* VM_SEL: OPAMP2 inverting input
              selection */
   { "\x50\x33\x65\x14\xe0", 7, 1 },  /* TCM_EN: Timer controlled Mux mode
              enable */
   { "\x58\xd4\xe5\x4c\x53\x00", 8, 1 },  /* VMS_SEL: OPAMP2 inverting input secondary
              selection */
   { "\x59\x04\xe5\x4c\x53\x00", 9, 2 },  /* VPS_SEL: OPAMP2 Non inverting input secondary
              selection */
   { "\x0c\x13\x0f\x38", 11, 1 },  /* CALON: Calibration mode enable */
...
const Field_t OPAMP_OPAMP3_CR_fields[] = {
   ...
   { "\x18\xf4\x83\x16\x55\x90", 1, 1 },  /* FORCE_VP: FORCE_VP */
   { "\x59\x09\x53\x14\xc0", 2, 2 },  /* VP_SEL: OPAMP3 Non inverting input
              selection */
   { "\x58\xd9\x53\x14\xc0", 5, 2 },  /* VM_SEL: OPAMP3 inverting input
              selection */
   { "\x50\x33\x65\x14\xe0", 7, 1 },  /* TCM_EN: Timer controlled Mux mode
              enable */
   { "\x58\xd4\xe5\x4c\x53\x00", 8, 1 },  /* VMS_SEL: OPAMP3 inverting input secondary
              selection */
   { "\x59\x04\xe5\x4c\x53\x00", 9, 2 },  /* VPS_SEL: OPAMP3 Non inverting input secondary
              selection */
   { "\x0c\x13\x0f\x38", 11, 1 },  /* CALON: Calibration mode enable */
   { "\x0c\x13\x13\x14\xc0", 12, 2 },  /* CALSEL: Calibration selection */
   { "\x40\x70\x65\x1c\x12\x4e", 14, 4 },  /* PGA_GAIN: Gain in PGA mode */
...
const Field_t OPAMP_OPAMP4_CR_fields[] = {
   ...
   { "\x18\xf4\x83\x16\x55\x90", 1, 1 },  /* FORCE_VP: FORCE_VP */
   { "\x59\x09\x53\x14\xc0", 2, 2 },  /* VP_SEL: OPAMP4 Non inverting input
              selection */
   { "\x58\xd9\x53\x14\xc0", 5, 2 },  /* VM_SEL: OPAMP4 inverting input
              selection */
   { "\x50\x33\x65\x14\xe0", 7, 1 },  /* TCM_EN: Timer controlled Mux mode
              enable */
   { "\x58\xd4\xe5\x4c\x53\x00", 8, 1 },  /* VMS_SEL: OPAMP4 inverting input secondary
              selection */
   { "\x59\x04\xe5\x4c\x53\x00", 9, 2 },  /* VPS_SEL: OPAMP4 Non inverting input secondary
              selection */
   { "\x0c\x13\x0f\x38", 11, 1 },  /* CALON: Calibration mode enable */
   { "\x0c\x13\x13\x14\xc0", 12, 2 },  /* CALSEL: Calibration selection */
   { "\x40\x70\x65\x1c\x12\x4e", 14, 4 },  /* PGA_GAIN: Gain in PGA mode */
...
const Field_t EXTI_RTSR1_fields[] = {
   ...
   { "\x51\x27\x5d", 22, 1 },  /* TR22: Rising trigger event configuration of
              line 22 */
   { "\x51\x27\x64", 29, 1 },  /* TR29: Rising trigger event configuration of
              line 29 */
   { "\x51\x27\x9b", 30, 1 },  /* TR30: Rising trigger event configuration of
              line 30 */
   { "\x51\x27\x9c", 31, 1 },  /* TR31: Rising trigger event configuration of
              line 31 */
};
...
const Field_t EXTI_FTSR1_fields[] = {
   ...
   { "\x51\x27\x5d", 22, 1 },  /* TR22: Falling trigger event configuration of
              line 22 */
   { "\x51\x27\x64", 29, 1 },  /* TR29: Falling trigger event configuration of
              line 29 */
   { "\x51\x27\x9b", 30, 1 },  /* TR30: Falling trigger event configuration of
              line 30. */
   { "\x51\x27\x9c", 31, 1 },  /* TR31: Falling trigger event configuration of
              line 31 */
};
...
const Field_t EXTI_SWIER1_fields[] = {
   ...
   { "\x4d\x72\x45\x49\xd7\x40", 22, 1 },  /* SWIER22: Software Interrupt on line
              22 */
   { "\x4d\x72\x45\x49\xd9\x00", 29, 1 },  /* SWIER29: Software Interrupt on line
              29 */
   { "\x4d\x72\x45\x49\xe6\xc0", 30, 1 },  /* SWIER30: Software Interrupt on line
              309 */
   { "\x4d\x72\x45\x49\xe7\x00", 31, 1 },  /* SWIER31: Software Interrupt on line
              319 */
};
...
const Field_t EXTI_RTSR2_fields[] = {
   { "\x51\x27\x9d", 0, 1 },  /* TR32: Rising trigger event configuration bit
              of line 32 */
   { "\x51\x27\x9e", 1, 1 },  /* TR33: Rising trigger event configuration bit
              of line 33 */
};

const Field_t EXTI_FTSR2_fields[] = {
   { "\x51\x27\x9d", 0, 1 },  /* TR32: Falling trigger event configuration bit
              of line 32 */
   { "\x51\x27\x9e", 1, 1 },  /* TR33: Falling trigger event configuration bit
              of line 33 */
};

const Field_t EXTI_SWIER2_fields[] = {
   { "\x4d\x72\x45\x49\xe7\x40", 0, 1 },  /* SWIER32: Software interrupt on line
              32 */
   { "\x4d\x72\x45\x49\xe7\x80", 1, 1 },  /* SWIER33: Software interrupt on line
              33 */
};
...
const Register_t EXTI_registers[] = {
   ...
   {"\x49\x44\xd2\x70", 8, 32, 0, EXTI_RTSR1_fields, 26}, /* RTSR1: Rising Trigger selection
          register */
   {"\x19\x44\xd2\x70", 12, 32, 0, EXTI_FTSR1_fields, 26}, /* FTSR1: Falling Trigger selection
          register */
   {"\x4d\x72\x45\x49\xc0", 16, 32, 0, EXTI_SWIER1_fields, 26}, /* SWIER1: Software interrupt event
          register */
   ...
   {"\x49\x44\xd2\x74", 32, 32, 0, EXTI_RTSR2_fields, 2}, /* RTSR2: Rising Trigger selection
          register */
   {"\x19\x44\xd2\x74", 36, 32, 0, EXTI_FTSR2_fields, 2}, /* FTSR2: Falling Trigger selection
          register */
   {"\x4d\x72\x45\x49\xd0", 40, 32, 0, EXTI_SWIER2_fields, 2}, /* SWIER2: Software interrupt event
          register */
...
const Field_t TIM1_SR_fields[] = {
   ...
   { "\x0c\x37\xcf\x18", 12, 1 },  /* CC4OF: Capture/Compare 4 overcapture
              flag */
   { "\x0e\x02\x46", 16, 1 },  /* C5IF: Capture/Compare 5 interrupt
              flag */
   { "\x0e\x12\x46", 17, 1 },  /* C6IF: Capture/Compare 6 interrupt
              flag */
};
...
const Field_t TIM1_CCMR2_Output_fields[] = {
   ...
   { "\x3c\x37\xc3\x14", 15, 1 },  /* OC4CE: Output compare 4 clear
              enable */
   { "\x3c\x37\x8d\x95\xe0", 16, 1 },  /* OC3M_3: Output Compare 3 mode bit
              3 */
   { "\x3c\x37\xcd\x95\xe0", 24, 1 },  /* OC4M_3: Output Compare 4 mode bit
              3 */
};
...
const Field_t TIM1_CCER_fields[] = {
   ...
   { "\x0c\x37\xce\x40", 15, 1 },  /* CC4NP: Capture/Compare 4 output
              Polarity */
   { "\x0c\x38\x05", 16, 1 },  /* CC5E: Capture/Compare 5 output
              enable */
   { "\x0c\x38\x10", 17, 1 },  /* CC5P: Capture/Compare 5 output
              Polarity */
   { "\x0c\x38\x45", 20, 1 },  /* CC6E: Capture/Compare 6 output
              enable */
   { "\x0c\x38\x50", 21, 1 },  /* CC6P: Capture/Compare 6 output
              Polarity */
};
...
const Field_t TIM1_CCMR3_Output_fields[] = {
   ...
   { "\x3c\x38\x43\x14", 15, 1 },  /* OC6CE: Output compare 6 clear
              enable */
   { "\x3c\x38\x0d\x95\xe0", 16, 1 },  /* OC5M_3: Outout Compare 5 mode bit
              3 */
   { "\x3c\x38\x4d\x95\xe0", 24, 1 },  /* OC6M_3: Outout Compare 6 mode bit
              3 */
};
...
const Field_t TIM1_OR_fields[] = {
   { "\x50\x93\x5c\x94\x55\x12\x94\x11\x03\x72\x54\x8d\x40", 0, 2 },  /* TIM1_ETR_ADC1_RMP: TIM1_ETR_ADC1 remapping
              capability */
   { "\x50\x93\x5c\x94\x55\x12\x94\x11\x03\x7e\x54\x8d\x40", 2, 2 },  /* TIM1_ETR_ADC4_RMP: TIM1_ETR_ADC4 remapping
              capability */
};
...
const Register_t TIM1_registers[] = {
   ...
   {"\x0c\x33\x52\x72\x53\xd5\x51\x05\x54", 24, 32, 0, TIM1_CCMR1_Output_fields, 12}, /* CCMR1_Output: capture/compare mode register (output
          mode) */
   ...
   {"\x0c\x33\x52\x76\x52\x4e\x41\x55\x00", 28, 32, 0, TIM1_CCMR2_Input_fields, 6}, /* CCMR2_Input: capture/compare mode register 2 (input
          mode) */
   {"\x0c\x33\x52\x76\x53\xd5\x51\x05\x54", 28, 32, 0, TIM1_CCMR2_Output_fields, 12}, /* CCMR2_Output: capture/compare mode register (output
          mode) */
   {"\x0c\x31\x52", 32, 32, 0, TIM1_CCER_fields, 19}, /* CCER: capture/compare enable
          register */
   ...
   {"\x0c\x33\x52\x7a\x53\xd5\x51\x05\x54", 84, 32, 0, TIM1_CCMR3_Output_fields, 10}, /* CCMR3_Output: capture/compare mode register 3 (output
          mode) */
...
const Field_t TIM8_OR_fields[] = {
   { "\x50\x93\x63\x94\x55\x12\x94\x11\x03\x76\x54\x8d\x40", 0, 2 },  /* TIM8_ETR_ADC2_RMP: TIM8_ETR_ADC2 remapping
              capability */
   { "\x50\x93\x63\x94\x55\x12\x94\x11\x03\x7a\x54\x8d\x40", 2, 2 },  /* TIM8_ETR_ADC3_RMP: TIM8_ETR_ADC3 remapping
              capability */
};
...
const Register_t TIM8_registers[] = {
   ...
   {"\x0c\x33\x52\x72\x53\xd5\x51\x05\x54", 24, 32, 0, TIM8_CCMR1_Output_fields, 12}, /* CCMR1_Output: capture/compare mode register (output
          mode) */
   {"\x0c\x33\x52\x72\x52\x4e\x41\x55\x00", 24, 32, 0, TIM8_CCMR1_Input_fields, 6}, /* CCMR1_Input: capture/compare mode register 1 (input
          mode) */
   {"\x0c\x33\x52\x76\x52\x4e\x41\x55\x00", 28, 32, 0, TIM8_CCMR2_Input_fields, 6}, /* CCMR2_Input: capture/compare mode register 2 (input
          mode) */
   {"\x0c\x33\x52\x76\x53\xd5\x51\x05\x54", 28, 32, 0, TIM8_CCMR2_Output_fields, 12}, /* CCMR2_Output: capture/compare mode register (output
          mode) */
   {"\x0c\x31\x52", 32, 32, 0, TIM8_CCER_fields, 19}, /* CCER: capture/compare enable
          register */
   ...
   {"\x0c\x33\x52\x7a\x53\xd5\x51\x05\x54", 84, 32, 0, TIM8_CCMR3_Output_fields, 10}, /* CCMR3_Output: capture/compare mode register 3 (output
          mode) */
...
const Field_t USART1_CR1_fields[] = {
   ...
   { "\x10\x51\x14", 16, 5 },  /* DEDT: Driver Enable deassertion
              time */
   { "\x10\x50\x54", 21, 5 },  /* DEAT: Driver Enable assertion
              time */
...
const Field_t USART1_ISR_fields[] = {
   ...
   { "\x49\x75\x40", 19, 1 },  /* RWU: Receiver wakeup from Mute
              mode */
   { "\x5d\x51\x80", 20, 1 },  /* WUF: Wakeup from Stop mode flag */
   { "\x50\x50\x43\x2c", 21, 1 },  /* TEACK: Transmit enable acknowledge
              flag */
   { "\x48\x50\x43\x2c", 22, 1 },  /* REACK: Receive enable acknowledge
              flag */
};
...
const Register_t TIM15_registers[] = {
   ...
   {"\x0c\x33\x52\x72\x52\x4e\x41\x55\x00", 24, 32, 0, TIM15_CCMR1_Input_fields, 6}, /* CCMR1_Input: capture/compare mode register 1 (input
          mode) */
   {"\x0c\x33\x52\x72\x53\xd5\x51\x05\x54", 24, 32, 0, TIM15_CCMR1_Output_fields, 10}, /* CCMR1_Output: capture/compare mode register (output
          mode) */
   {"\x0c\x31\x52", 32, 32, 0, TIM15_CCER_fields, 7}, /* CCER: capture/compare enable
          register */
...
const Register_t TIM17_registers[] = {
   ...
   {"\x0c\x33\x52\x72\x53\xd5\x51\x05\x54", 24, 32, 0, TIM17_CCMR1_Output_fields, 5}, /* CCMR1_Output: capture/compare mode register (output
          mode) */
   {"\x0c\x33\x52\x72\x52\x4e\x41\x55\x00", 24, 32, 0, TIM17_CCMR1_Input_fields, 3}, /* CCMR1_Input: capture/compare mode register 1 (input
          mode) */
   {"\x0c\x31\x52", 32, 32, 0, TIM17_CCER_fields, 4}, /* CCER: capture/compare enable
          register */
...
const Field_t DMA1_ISR_fields[] = {
   { "\x1c\x91\x9c", 0, 1 },  /* GIF1: Channel 1 Global interrupt
              flag */
   { "\x50\x32\x46\x70", 1, 1 },  /* TCIF1: Channel 1 Transfer Complete
              flag */
   { "\x21\x42\x46\x70", 2, 1 },  /* HTIF1: Channel 1 Half Transfer Complete
              flag */
   { "\x50\x52\x46\x70", 3, 1 },  /* TEIF1: Channel 1 Transfer Error
              flag */
   { "\x1c\x91\x9d", 4, 1 },  /* GIF2: Channel 2 Global interrupt
              flag */
   { "\x50\x32\x46\x74", 5, 1 },  /* TCIF2: Channel 2 Transfer Complete
              flag */
   { "\x21\x42\x46\x74", 6, 1 },  /* HTIF2: Channel 2 Half Transfer Complete
              flag */
   { "\x50\x52\x46\x74", 7, 1 },  /* TEIF2: Channel 2 Transfer Error
              flag */
   { "\x1c\x91\x9e", 8, 1 },  /* GIF3: Channel 3 Global interrupt
              flag */
   { "\x50\x32\x46\x78", 9, 1 },  /* TCIF3: Channel 3 Transfer Complete
              flag */
   { "\x21\x42\x46\x78", 10, 1 },  /* HTIF3: Channel 3 Half Transfer Complete
              flag */
   { "\x50\x52\x46\x78", 11, 1 },  /* TEIF3: Channel 3 Transfer Error
              flag */
   { "\x1c\x91\x9f", 12, 1 },  /* GIF4: Channel 4 Global interrupt
              flag */
   { "\x50\x32\x46\x7c", 13, 1 },  /* TCIF4: Channel 4 Transfer Complete
              flag */
   { "\x21\x42\x46\x7c", 14, 1 },  /* HTIF4: Channel 4 Half Transfer Complete
              flag */
   { "\x50\x52\x46\x7c", 15, 1 },  /* TEIF4: Channel 4 Transfer Error
              flag */
   { "\x1c\x91\xa0", 16, 1 },  /* GIF5: Channel 5 Global interrupt
              flag */
   { "\x50\x32\x46\x80", 17, 1 },  /* TCIF5: Channel 5 Transfer Complete
              flag */
   { "\x21\x42\x46\x80", 18, 1 },  /* HTIF5: Channel 5 Half Transfer Complete
              flag */
   { "\x50\x52\x46\x80", 19, 1 },  /* TEIF5: Channel 5 Transfer Error
              flag */
   { "\x1c\x91\xa1", 20, 1 },  /* GIF6: Channel 6 Global interrupt
              flag */
   { "\x50\x32\x46\x84", 21, 1 },  /* TCIF6: Channel 6 Transfer Complete
              flag */
   { "\x21\x42\x46\x84", 22, 1 },  /* HTIF6: Channel 6 Half Transfer Complete
              flag */
   { "\x50\x52\x46\x84", 23, 1 },  /* TEIF6: Channel 6 Transfer Error
              flag */
   { "\x1c\x91\xa2", 24, 1 },  /* GIF7: Channel 7 Global interrupt
              flag */
   { "\x50\x32\x46\x88", 25, 1 },  /* TCIF7: Channel 7 Transfer Complete
              flag */
   { "\x21\x42\x46\x88", 26, 1 },  /* HTIF7: Channel 7 Half Transfer Complete
              flag */
   { "\x50\x52\x46\x88", 27, 1 },  /* TEIF7: Channel 7 Transfer Error
              flag */
};

const Field_t DMA1_IFCR_fields[] = {
   { "\x0c\x72\x46\x70", 0, 1 },  /* CGIF1: Channel 1 Global interrupt
              clear */
   { "\x0d\x40\xc9\x19\xc0", 1, 1 },  /* CTCIF1: Channel 1 Transfer Complete
              clear */
   { "\x0c\x85\x09\x19\xc0", 2, 1 },  /* CHTIF1: Channel 1 Half Transfer
              clear */
   { "\x0d\x41\x49\x19\xc0", 3, 1 },  /* CTEIF1: Channel 1 Transfer Error
              clear */
   { "\x0c\x72\x46\x74", 4, 1 },  /* CGIF2: Channel 2 Global interrupt
              clear */
   { "\x0d\x40\xc9\x19\xd0", 5, 1 },  /* CTCIF2: Channel 2 Transfer Complete
              clear */
   { "\x0c\x85\x09\x19\xd0", 6, 1 },  /* CHTIF2: Channel 2 Half Transfer
              clear */
   { "\x0d\x41\x49\x19\xd0", 7, 1 },  /* CTEIF2: Channel 2 Transfer Error
              clear */
   { "\x0c\x72\x46\x78", 8, 1 },  /* CGIF3: Channel 3 Global interrupt
              clear */
   { "\x0d\x40\xc9\x19\xe0", 9, 1 },  /* CTCIF3: Channel 3 Transfer Complete
              clear */
   { "\x0c\x85\x09\x19\xe0", 10, 1 },  /* CHTIF3: Channel 3 Half Transfer
              clear */
   { "\x0d\x41\x49\x19\xe0", 11, 1 },  /* CTEIF3: Channel 3 Transfer Error
              clear */
   { "\x0c\x72\x46\x7c", 12, 1 },  /* CGIF4: Channel 4 Global interrupt
              clear */
   { "\x0d\x40\xc9\x19\xf0", 13, 1 },  /* CTCIF4: Channel 4 Transfer Complete
              clear */
   { "\x0c\x85\x09\x19\xf0", 14, 1 },  /* CHTIF4: Channel 4 Half Transfer
              clear */
   { "\x0d\x41\x49\x19\xf0", 15, 1 },  /* CTEIF4: Channel 4 Transfer Error
              clear */
   { "\x0c\x72\x46\x80", 16, 1 },  /* CGIF5: Channel 5 Global interrupt
              clear */
   { "\x0d\x40\xc9\x1a\x00", 17, 1 },  /* CTCIF5: Channel 5 Transfer Complete
              clear */
   { "\x0c\x85\x09\x1a\x00", 18, 1 },  /* CHTIF5: Channel 5 Half Transfer
              clear */
   { "\x0d\x41\x49\x1a\x00", 19, 1 },  /* CTEIF5: Channel 5 Transfer Error
              clear */
   { "\x0c\x72\x46\x84", 20, 1 },  /* CGIF6: Channel 6 Global interrupt
              clear */
   { "\x0d\x40\xc9\x1a\x10", 21, 1 },  /* CTCIF6: Channel 6 Transfer Complete
              clear */
   { "\x0c\x85\x09\x1a\x10", 22, 1 },  /* CHTIF6: Channel 6 Half Transfer
              clear */
   { "\x0d\x41\x49\x1a\x10", 23, 1 },  /* CTEIF6: Channel 6 Transfer Error
              clear */
   { "\x0c\x72\x46\x88", 24, 1 },  /* CGIF7: Channel 7 Global interrupt
              clear */
   { "\x0d\x40\xc9\x1a\x20", 25, 1 },  /* CTCIF7: Channel 7 Transfer Complete
              clear */
   { "\x0c\x85\x09\x1a\x20", 26, 1 },  /* CHTIF7: Channel 7 Half Transfer
              clear */
   { "\x0d\x41\x49\x1a\x20", 27, 1 },  /* CTEIF7: Channel 7 Transfer Error
              clear */
};
...
const Register_t DMA1_registers[] = {
   {"\x25\x34\x80", 0, 32, 0, DMA1_ISR_fields, 28}, /* ISR: DMA interrupt status register
          (DMA_ISR) */
   {"\x24\x60\xd2", 4, 32, 0, DMA1_IFCR_fields, 28}, /* IFCR: DMA interrupt flag clear register
          (DMA_IFCR) */
   {"\x0c\x34\x9c", 8, 32, 0, DMA1_CCR1_fields, 12}, /* CCR1: DMA channel configuration register
          (DMA_CCR) */
   {"\x0c\xe1\x14\x49\xc0", 12, 32, 0, DMA1_CNDTR1_fields, 1}, /* CNDTR1: DMA channel 1 number of data
          register */
   {"\x0d\x00\x52\x70", 16, 32, 0, DMA1_CPAR1_fields, 1}, /* CPAR1: DMA channel 1 peripheral address
          register */
   {"\x0c\xd0\x52\x70", 20, 32, 0, DMA1_CMAR1_fields, 1}, /* CMAR1: DMA channel 1 memory address
          register */
   {"\x0c\x34\x9d", 28, 32, 0, DMA1_CCR2_fields, 12}, /* CCR2: DMA channel configuration register
          (DMA_CCR) */
   {"\x0c\xe1\x14\x49\xd0", 32, 32, 0, DMA1_CNDTR2_fields, 1}, /* CNDTR2: DMA channel 2 number of data
          register */
   {"\x0d\x00\x52\x74", 36, 32, 0, DMA1_CPAR2_fields, 1}, /* CPAR2: DMA channel 2 peripheral address
          register */
   {"\x0c\xd0\x52\x74", 40, 32, 0, DMA1_CMAR2_fields, 1}, /* CMAR2: DMA channel 2 memory address
          register */
   {"\x0c\x34\x9e", 48, 32, 0, DMA1_CCR3_fields, 12}, /* CCR3: DMA channel configuration register
          (DMA_CCR) */
   {"\x0c\xe1\x14\x49\xe0", 52, 32, 0, DMA1_CNDTR3_fields, 1}, /* CNDTR3: DMA channel 3 number of data
          register */
   {"\x0d\x00\x52\x78", 56, 32, 0, DMA1_CPAR3_fields, 1}, /* CPAR3: DMA channel 3 peripheral address
          register */
   {"\x0c\xd0\x52\x78", 60, 32, 0, DMA1_CMAR3_fields, 1}, /* CMAR3: DMA channel 3 memory address
          register */
   {"\x0c\x34\x9f", 68, 32, 0, DMA1_CCR4_fields, 12}, /* CCR4: DMA channel configuration register
          (DMA_CCR) */
   {"\x0c\xe1\x14\x49\xf0", 72, 32, 0, DMA1_CNDTR4_fields, 1}, /* CNDTR4: DMA channel 4 number of data
          register */
   {"\x0d\x00\x52\x7c", 76, 32, 0, DMA1_CPAR4_fields, 1}, /* CPAR4: DMA channel 4 peripheral address
          register */
   {"\x0c\xd0\x52\x7c", 80, 32, 0, DMA1_CMAR4_fields, 1}, /* CMAR4: DMA channel 4 memory address
          register */
   {"\x0c\x34\xa0", 88, 32, 0, DMA1_CCR5_fields, 12}, /* CCR5: DMA channel configuration register
          (DMA_CCR) */
   {"\x0c\xe1\x14\x4a\x00", 92, 32, 0, DMA1_CNDTR5_fields, 1}, /* CNDTR5: DMA channel 5 number of data
          register */
   {"\x0d\x00\x52\x80", 96, 32, 0, DMA1_CPAR5_fields, 1}, /* CPAR5: DMA channel 5 peripheral address
          register */
   {"\x0c\xd0\x52\x80", 100, 32, 0, DMA1_CMAR5_fields, 1}, /* CMAR5: DMA channel 5 memory address
          register */
   {"\x0c\x34\xa1", 108, 32, 0, DMA1_CCR6_fields, 12}, /* CCR6: DMA channel configuration register
          (DMA_CCR) */
   {"\x0c\xe1\x14\x4a\x10", 112, 32, 0, DMA1_CNDTR6_fields, 1}, /* CNDTR6: DMA channel 6 number of data
          register */
   {"\x0d\x00\x52\x84", 116, 32, 0, DMA1_CPAR6_fields, 1}, /* CPAR6: DMA channel 6 peripheral address
          register */
   {"\x0c\xd0\x52\x84", 120, 32, 0, DMA1_CMAR6_fields, 1}, /* CMAR6: DMA channel 6 memory address
          register */
   {"\x0c\x34\xa2", 128, 32, 0, DMA1_CCR7_fields, 12}, /* CCR7: DMA channel configuration register
          (DMA_CCR) */
   {"\x0c\xe1\x14\x4a\x20", 132, 32, 0, DMA1_CNDTR7_fields, 1}, /* CNDTR7: DMA channel 7 number of data
          register */
   {"\x0d\x00\x52\x88", 136, 32, 0, DMA1_CPAR7_fields, 1}, /* CPAR7: DMA channel 7 peripheral address
          register */
   {"\x0c\xd0\x52\x88", 140, 32, 0, DMA1_CMAR7_fields, 1}, /* CMAR7: DMA channel 7 memory address
          register */
};
...
const Field_t RCC_CR_fields[] = {
   ...
   { "\x21\x32\x43\x04\xc0", 8, 8 },  /* HSICAL: Internal High Speed clock
              Calibration */
   { "\x21\x31\x4f\x38", 16, 1 },  /* HSEON: External High Speed clock
              enable */
   { "\x21\x31\x52\x11\x90", 17, 1 },  /* HSERDY: External High Speed clock ready
              flag */
   { "\x21\x31\x42\x65\x00", 18, 1 },  /* HSEBYP: External High Speed clock
              Bypass */
...
const Field_t RCC_CFGR_fields[] = {
   ...
   { "\x41\x04\x85\x70", 8, 3 },  /* PPRE1: APB Low speed prescaler
              (APB1) */
   { "\x41\x04\x85\x74", 11, 3 },  /* PPRE2: APB high speed prescaler
              (APB2) */
   { "\x40\xc3\x13\x48\x30", 16, 1 },  /* PLLSRC: PLL entry clock source */
   ...
   { "\x25\xd4\xd3\x48\x30", 23, 1 },  /* I2SSRC: I2S external clock source
              selection */
   { "\x34\x33\xc0", 24, 3 },  /* MCO: Microcontroller clock
              output */
   { "\x34\x33\xc6", 28, 1 },  /* MCOF: Microcontroller Clock Output
              Flag */
};
...
const Field_t RCC_AHBENR_fields[] = {
   ...
   { "\x4d\x20\x4d\x14\xe0", 2, 1 },  /* SRAMEN: SRAM interface clock
              enable */
   ...
   { "\x51\x30\xc5\x38", 24, 1 },  /* TSCEN: Touch sensing controller clock
              enable */
...
const Field_t RCC_BDCR_fields[] = {
   ...
   { "\x31\x31\x42\x65\x00", 2, 1 },  /* LSEBYP: External Low Speed oscillator
              bypass */
   { "\x31\x31\x44\x49\x60", 3, 2 },  /* LSEDRV: LSE oscillator drive
              capability */
...
const Field_t RCC_CSR_fields[] = {
   ...
   { "\x25\x71\x07\x49\x35\x06", 29, 1 },  /* IWDGRSTF: Independent watchdog reset
              flag */
...
const Field_t RCC_AHBRSTR_fields[] = {
   ...
   { "\x51\x30\xd2\x4d\x40", 24, 1 },  /* TSCRST: Touch sensing controller
              reset */
...
const Field_t RCC_CFGR3_fields[] = {
   { "\x55\x30\x52\x51\xc4\xd7", 0, 2 },  /* USART1SW: USART1 clock source
              selection */
   { "\x25\xd0\xdc\x4d\x70", 4, 1 },  /* I2C1SW: I2C1 clock source
              selection */
   { "\x25\xd0\xdd\x4d\x70", 5, 1 },  /* I2C2SW: I2C2 clock source
              selection */
   { "\x50\x93\x5c\x4d\x70", 8, 1 },  /* TIM1SW: Timer1 clock source
              selection */
   { "\x50\x93\x63\x4d\x70", 9, 1 },  /* TIM8SW: Timer8 clock source
              selection */
   { "\x55\x30\x52\x51\xd4\xd7", 16, 2 },  /* USART2SW: USART2 clock source
              selection */
   { "\x55\x30\x52\x51\xe4\xd7", 18, 2 },  /* USART3SW: USART3 clock source
              selection */
   { "\x54\x14\x94\x7d\x35\xc0", 20, 2 },  /* UART4SW: UART4 clock source
              selection */
   { "\x54\x14\x94\x81\x35\xc0", 22, 2 },  /* UART5SW: UART5 clock source
              selection */
};

const Register_t RCC_registers[] = {
   {"\x0d\x20", 0, 32, 0, RCC_CR_fields, 10}, /* CR: Clock control register */
   {"\x0c\x61\xd2", 4, 32, 0, RCC_CFGR_fields, 12}, /* CFGR: Clock configuration register
          (RCC_CFGR) */
   {"\x0c\x94\x80", 8, 32, 0, RCC_CIR_fields, 17}, /* CIR: Clock interrupt register
          (RCC_CIR) */
   {"\x05\x00\x9d\x49\x35\x12", 12, 32, 0, RCC_APB2RSTR_fields, 8}, /* APB2RSTR: APB2 peripheral reset register
          (RCC_APB2RSTR) */
   {"\x05\x00\x9c\x49\x35\x12", 16, 32, 0, RCC_APB1RSTR_fields, 18}, /* APB1RSTR: APB1 peripheral reset register
          (RCC_APB1RSTR) */
   {"\x04\x80\x85\x39\x20", 20, 32, 0, RCC_AHBENR_fields, 14}, /* AHBENR: AHB Peripheral Clock enable register
          (RCC_AHBENR) */
   {"\x05\x00\x9d\x14\xe4\x80", 24, 32, 0, RCC_APB2ENR_fields, 8}, /* APB2ENR: APB2 peripheral clock enable register
          (RCC_APB2ENR) */
   {"\x05\x00\x9c\x14\xe4\x80", 28, 32, 0, RCC_APB1ENR_fields, 15}, /* APB1ENR: APB1 peripheral clock enable register
          (RCC_APB1ENR) */
   {"\x08\x40\xd2", 32, 32, 0, RCC_BDCR_fields, 7}, /* BDCR: Backup domain control register
          (RCC_BDCR) */
   {"\x0d\x34\x80", 36, 32, 0, RCC_CSR_fields, 10}, /* CSR: Control/status register
          (RCC_CSR) */
...
const Field_t Flash_CR_fields[] = {
   ...
   { "\x14\xf4\x09\x14", 12, 1 },  /* EOPIE: End of operation interrupt
              enable */
...
const Field_t CRC_INIT_fields[] = {
   { "\x24\xe2\x54", 0, 32 },  /* INIT: Programmable initial CRC
              value */
};
...
const Field_t TSC_IOHCR_fields[] = {
   { "\x1d\xc9\x49\x3d\xc0", 0, 1 },  /* G1_IO1: G1_IO1 Schmitt trigger hysteresis
              mode */
   { "\x1d\xc9\x49\x3d\xd0", 1, 1 },  /* G1_IO2: G1_IO2 Schmitt trigger hysteresis
              mode */
   { "\x1d\xc9\x49\x3d\xe0", 2, 1 },  /* G1_IO3: G1_IO3 Schmitt trigger hysteresis
              mode */
   { "\x1d\xc9\x49\x3d\xf0", 3, 1 },  /* G1_IO4: G1_IO4 Schmitt trigger hysteresis
              mode */
   { "\x1d\xd9\x49\x3d\xc0", 4, 1 },  /* G2_IO1: G2_IO1 Schmitt trigger hysteresis
              mode */
   { "\x1d\xd9\x49\x3d\xd0", 5, 1 },  /* G2_IO2: G2_IO2 Schmitt trigger hysteresis
              mode */
   { "\x1d\xd9\x49\x3d\xe0", 6, 1 },  /* G2_IO3: G2_IO3 Schmitt trigger hysteresis
              mode */
   { "\x1d\xd9\x49\x3d\xf0", 7, 1 },  /* G2_IO4: G2_IO4 Schmitt trigger hysteresis
              mode */
   { "\x1d\xe9\x49\x3d\xc0", 8, 1 },  /* G3_IO1: G3_IO1 Schmitt trigger hysteresis
              mode */
   { "\x1d\xe9\x49\x3d\xd0", 9, 1 },  /* G3_IO2: G3_IO2 Schmitt trigger hysteresis
              mode */
   { "\x1d\xe9\x49\x3d\xe0", 10, 1 },  /* G3_IO3: G3_IO3 Schmitt trigger hysteresis
              mode */
   { "\x1d\xe9\x49\x3d\xf0", 11, 1 },  /* G3_IO4: G3_IO4 Schmitt trigger hysteresis
              mode */
   { "\x1d\xf9\x49\x3d\xc0", 12, 1 },  /* G4_IO1: G4_IO1 Schmitt trigger hysteresis
              mode */
   { "\x1d\xf9\x49\x3d\xd0", 13, 1 },  /* G4_IO2: G4_IO2 Schmitt trigger hysteresis
              mode */
   { "\x1d\xf9\x49\x3d\xe0", 14, 1 },  /* G4_IO3: G4_IO3 Schmitt trigger hysteresis
              mode */
   { "\x1d\xf9\x49\x3d\xf0", 15, 1 },  /* G4_IO4: G4_IO4 Schmitt trigger hysteresis
              mode */
   { "\x1e\x09\x49\x3d\xc0", 16, 1 },  /* G5_IO1: G5_IO1 Schmitt trigger hysteresis
              mode */
   { "\x1e\x09\x49\x3d\xd0", 17, 1 },  /* G5_IO2: G5_IO2 Schmitt trigger hysteresis
              mode */
   { "\x1e\x09\x49\x3d\xe0", 18, 1 },  /* G5_IO3: G5_IO3 Schmitt trigger hysteresis
              mode */
   { "\x1e\x09\x49\x3d\xf0", 19, 1 },  /* G5_IO4: G5_IO4 Schmitt trigger hysteresis
              mode */
   { "\x1e\x19\x49\x3d\xc0", 20, 1 },  /* G6_IO1: G6_IO1 Schmitt trigger hysteresis
              mode */
   { "\x1e\x19\x49\x3d\xd0", 21, 1 },  /* G6_IO2: G6_IO2 Schmitt trigger hysteresis
              mode */
   { "\x1e\x19\x49\x3d\xe0", 22, 1 },  /* G6_IO3: G6_IO3 Schmitt trigger hysteresis
              mode */
   { "\x1e\x19\x49\x3d\xf0", 23, 1 },  /* G6_IO4: G6_IO4 Schmitt trigger hysteresis
              mode */
   { "\x1e\x29\x49\x3d\xc0", 24, 1 },  /* G7_IO1: G7_IO1 Schmitt trigger hysteresis
              mode */
   { "\x1e\x29\x49\x3d\xd0", 25, 1 },  /* G7_IO2: G7_IO2 Schmitt trigger hysteresis
              mode */
   { "\x1e\x29\x49\x3d\xe0", 26, 1 },  /* G7_IO3: G7_IO3 Schmitt trigger hysteresis
              mode */
   { "\x1e\x29\x49\x3d\xf0", 27, 1 },  /* G7_IO4: G7_IO4 Schmitt trigger hysteresis
              mode */
   { "\x1e\x39\x49\x3d\xc0", 28, 1 },  /* G8_IO1: G8_IO1 Schmitt trigger hysteresis
              mode */
   { "\x1e\x39\x49\x3d\xd0", 29, 1 },  /* G8_IO2: G8_IO2 Schmitt trigger hysteresis
              mode */
   { "\x1e\x39\x49\x3d\xe0", 30, 1 },  /* G8_IO3: G8_IO3 Schmitt trigger hysteresis
              mode */
   { "\x1e\x39\x49\x3d\xf0", 31, 1 },  /* G8_IO4: G8_IO4 Schmitt trigger hysteresis
              mode */
};

const Field_t TSC_IOASCR_fields[] = {
   { "\x1d\xc9\x49\x3d\xc0", 0, 1 },  /* G1_IO1: G1_IO1 analog switch
              enable */
   { "\x1d\xc9\x49\x3d\xd0", 1, 1 },  /* G1_IO2: G1_IO2 analog switch
              enable */
   { "\x1d\xc9\x49\x3d\xe0", 2, 1 },  /* G1_IO3: G1_IO3 analog switch
              enable */
   { "\x1d\xc9\x49\x3d\xf0", 3, 1 },  /* G1_IO4: G1_IO4 analog switch
              enable */
   { "\x1d\xd9\x49\x3d\xc0", 4, 1 },  /* G2_IO1: G2_IO1 analog switch
              enable */
   { "\x1d\xd9\x49\x3d\xd0", 5, 1 },  /* G2_IO2: G2_IO2 analog switch
              enable */
   { "\x1d\xd9\x49\x3d\xe0", 6, 1 },  /* G2_IO3: G2_IO3 analog switch
              enable */
   { "\x1d\xd9\x49\x3d\xf0", 7, 1 },  /* G2_IO4: G2_IO4 analog switch
              enable */
   { "\x1d\xe9\x49\x3d\xc0", 8, 1 },  /* G3_IO1: G3_IO1 analog switch
              enable */
   { "\x1d\xe9\x49\x3d\xd0", 9, 1 },  /* G3_IO2: G3_IO2 analog switch
              enable */
   { "\x1d\xe9\x49\x3d\xe0", 10, 1 },  /* G3_IO3: G3_IO3 analog switch
              enable */
   { "\x1d\xe9\x49\x3d\xf0", 11, 1 },  /* G3_IO4: G3_IO4 analog switch
              enable */
   { "\x1d\xf9\x49\x3d\xc0", 12, 1 },  /* G4_IO1: G4_IO1 analog switch
              enable */
   { "\x1d\xf9\x49\x3d\xd0", 13, 1 },  /* G4_IO2: G4_IO2 analog switch
              enable */
   { "\x1d\xf9\x49\x3d\xe0", 14, 1 },  /* G4_IO3: G4_IO3 analog switch
              enable */
   { "\x1d\xf9\x49\x3d\xf0", 15, 1 },  /* G4_IO4: G4_IO4 analog switch
              enable */
   { "\x1e\x09\x49\x3d\xc0", 16, 1 },  /* G5_IO1: G5_IO1 analog switch
              enable */
   { "\x1e\x09\x49\x3d\xd0", 17, 1 },  /* G5_IO2: G5_IO2 analog switch
              enable */
   { "\x1e\x09\x49\x3d\xe0", 18, 1 },  /* G5_IO3: G5_IO3 analog switch
              enable */
   { "\x1e\x09\x49\x3d\xf0", 19, 1 },  /* G5_IO4: G5_IO4 analog switch
              enable */
   { "\x1e\x19\x49\x3d\xc0", 20, 1 },  /* G6_IO1: G6_IO1 analog switch
              enable */
   { "\x1e\x19\x49\x3d\xd0", 21, 1 },  /* G6_IO2: G6_IO2 analog switch
              enable */
   { "\x1e\x19\x49\x3d\xe0", 22, 1 },  /* G6_IO3: G6_IO3 analog switch
              enable */
   { "\x1e\x19\x49\x3d\xf0", 23, 1 },  /* G6_IO4: G6_IO4 analog switch
              enable */
   { "\x1e\x29\x49\x3d\xc0", 24, 1 },  /* G7_IO1: G7_IO1 analog switch
              enable */
   { "\x1e\x29\x49\x3d\xd0", 25, 1 },  /* G7_IO2: G7_IO2 analog switch
              enable */
   { "\x1e\x29\x49\x3d\xe0", 26, 1 },  /* G7_IO3: G7_IO3 analog switch
              enable */
   { "\x1e\x29\x49\x3d\xf0", 27, 1 },  /* G7_IO4: G7_IO4 analog switch
              enable */
   { "\x1e\x39\x49\x3d\xc0", 28, 1 },  /* G8_IO1: G8_IO1 analog switch
              enable */
   { "\x1e\x39\x49\x3d\xd0", 29, 1 },  /* G8_IO2: G8_IO2 analog switch
              enable */
   { "\x1e\x39\x49\x3d\xe0", 30, 1 },  /* G8_IO3: G8_IO3 analog switch
              enable */
   { "\x1e\x39\x49\x3d\xf0", 31, 1 },  /* G8_IO4: G8_IO4 analog switch
              enable */
};
...
const Field_t GPIOB_OTYPER_fields[] = {
   ...
   { "\x3d\x47\x1b", 10, 1 },  /* OT10: Port x configuration bit
              10 */
   { "\x3d\x47\x1c", 11, 1 },  /* OT11: Port x configuration bit
              11 */
   { "\x3d\x47\x1d", 12, 1 },  /* OT12: Port x configuration bit
              12 */
   { "\x3d\x47\x1e", 13, 1 },  /* OT13: Port x configuration bit
              13 */
   { "\x3d\x47\x1f", 14, 1 },  /* OT14: Port x configuration bit
              14 */
   { "\x3d\x47\x20", 15, 1 },  /* OT15: Port x configuration bit
              15 */
};
...
const Register_t ADC1_registers[] = {
   ...
   {"\x05\x71\x1d\x0d\x20", 160, 32, 0, ADC1_AWD2CR_fields, 1}, /* AWD2CR: Analog Watchdog 2 Configuration
          Register */
   {"\x05\x71\x1e\x0d\x20", 164, 32, 0, ADC1_AWD3CR_fields, 1}, /* AWD3CR: Analog Watchdog 3 Configuration
          Register */
   {"\x10\x91\x93\x14\xc0", 176, 32, 0, ADC1_DIFSEL_fields, 2}, /* DIFSEL: Differential Mode Selection Register
          2 */
...
const Field_t ADC1_2_CSR_fields[] = {
   ...
   { "\x14\xf0\xe5\x4c\xc5\x80", 18, 1 },  /* EOC_SLV: End of regular conversion of the slave
              ADC */
   { "\x14\xf4\xe5\x4c\xc5\x80", 19, 1 },  /* EOS_SLV: End of regular sequence flag of the
              slave ADC */
   { "\x3d\x64\xa5\x4c\xc5\x80", 20, 1 },  /* OVR_SLV: Overrun flag of the slave
              ADC */
   { "\x28\x53\xc3\x95\x33\x16", 21, 1 },  /* JEOC_SLV: End of injected conversion flag of the
              slave ADC */
   { "\x28\x53\xd3\x95\x33\x16", 22, 1 },  /* JEOS_SLV: End of injected sequence flag of the
              slave ADC */
   { "\x05\x71\x1c\x95\x33\x16", 23, 1 },  /* AWD1_SLV: Analog watchdog 1 flag of the slave
              ADC */
   { "\x05\x71\x1d\x95\x33\x16", 24, 1 },  /* AWD2_SLV: Analog watchdog 2 flag of the slave
              ADC */
   { "\x05\x71\x1e\x95\x33\x16", 25, 1 },  /* AWD3_SLV: Analog watchdog 3 flag of the slave
              ADC */
   { "\x29\x13\xd6\x1a\x54\xcc\x58", 26, 1 },  /* JQOVF_SLV: Injected Context Queue Overflow flag of
              the slave ADC */
};
...
const Field_t ADC1_2_CCR_fields[] = {
   ...
   { "\x10\x53\x01\x64", 8, 4 },  /* DELAY: Delay between 2 sampling
              phases */
   { "\x10\xd0\x43\x18\x70", 13, 1 },  /* DMACFG: DMA configuration (for multi-ADC
              mode) */
   { "\x34\x43\x41", 14, 2 },  /* MDMA: Direct memory access mode for multi ADC
              mode */
...
const Field_t ADC1_2_CDR_fields[] = {
   { "\x48\x40\x54\x06\x53\x53\x50", 0, 16 },  /* RDATA_MST: Regular data of the master
              ADC */
   { "\x48\x40\x54\x06\x54\xcc\x58", 16, 16 },  /* RDATA_SLV: Regular data of the slave
              ADC */
};
...
const Register_t ADC1_2_registers[] = {
   ...
   {"\x0c\x44\x80", 12, 32, 0, ADC1_2_CDR_fields, 2}, /* CDR: ADC common regular data register for dual
          and triple modes */
};
...
const Field_t FPU_CPACR_fields[] = {
   { "\x0d\x06\xc0", 0, 1 },  /* CP0: Access privileges for coprocessor
              0 */
   { "\x0d\x07\x00", 2, 1 },  /* CP1: Access privileges for coprocessor
              1 */
   { "\x0d\x07\x40", 4, 1 },  /* CP2: Access privileges for coprocessor
              2 */
   { "\x0d\x07\x80", 6, 1 },  /* CP3: Access privileges for coprocessor
              3 */
   { "\x0d\x07\xc0", 8, 1 },  /* CP4: Access privileges for coprocessor
              4 */
   { "\x0d\x08\x00", 10, 1 },  /* CP5: Access privileges for coprocessor
              5 */
   { "\x0d\x08\x40", 12, 2 },  /* CP6: Access privileges for coprocessor
              6 */
   { "\x0d\x08\x80", 14, 1 },  /* CP7: Access privileges for coprocessor
              7 */
   { "\x0d\x07\x1b", 20, 1 },  /* CP10: Access privileges for coprocessor
              10 */
   { "\x0d\x07\x1c", 22, 1 },  /* CP11: Access privileges for coprocessor
              11 */
};
...
const Register_t FPU_registers[] = {
   {"\x0d\x00\x43\x48", 0, 32, 0, FPU_CPACR_fields, 10}, /* CPACR: Coprocessor Access Control
          Register */
   ...
   {"\x19\x01\x13\x0d\x20", 436, 32, 0, FPU_FPDSCR_fields, 4}, /* FPDSCR: FP Default Status Control
          Register */
   {"\x35\x61\x92\x6c", 440, 32, 0, FPU_MVFR0_fields, 8}, /* MVFR0: Media and VFP Feature Register
          0 */
   {"\x35\x61\x92\x70", 444, 32, 0, FPU_MVFR1_fields, 4}, /* MVFR1: Media and VFP Feature Register
          1 */
};
...
const Field_t DBGMCU_CR_fields[] = {
   ...
   { "\x51\x20\x43\x16\x52\x4f\x14\xe0", 5, 1 },  /* TRACE_IOEN: Trace pin assignment
              control */
   { "\x51\x20\x43\x16\x53\x4f\x10\x50", 6, 2 },  /* TRACE_MODE: Trace pin assignment
              control */
};

const Field_t DBGMCU_APB1FZ_fields[] = {
   { "\x10\x21\xe5\x50\x93\x5d\x95\x35\x0f\x40", 0, 1 },  /* DBG_TIM2_STOP: Debug Timer 2 stopped when Core is
              halted */
   { "\x10\x21\xe5\x50\x93\x5e\x95\x35\x0f\x40", 1, 1 },  /* DBG_TIM3_STOP: Debug Timer 3 stopped when Core is
              halted */
   { "\x10\x21\xe5\x50\x93\x5f\x95\x35\x0f\x40", 2, 1 },  /* DBG_TIM4_STOP: Debug Timer 4 stopped when Core is
              halted */
   { "\x10\x21\xe5\x50\x93\x60\x95\x35\x0f\x40", 3, 1 },  /* DBG_TIM5_STOP: Debug Timer 5 stopped when Core is
              halted */
   { "\x10\x21\xe5\x50\x93\x61\x95\x35\x0f\x40", 4, 1 },  /* DBG_TIM6_STOP: Debug Timer 6 stopped when Core is
              halted */
   { "\x10\x21\xe5\x50\x93\x62\x95\x35\x0f\x40", 5, 1 },  /* DBG_TIM7_STOP: Debug Timer 7 stopped when Core is
              halted */
   { "\x10\x21\xe5\x50\x93\x5c\x76\x54\xd4\x3d\x00", 6, 1 },  /* DBG_TIM12_STOP: Debug Timer 12 stopped when Core is
              halted */
   { "\x10\x21\xe5\x50\x93\x5c\x7a\x54\xd4\x3d\x00", 7, 1 },  /* DBG_TIM13_STOP: Debug Timer 13 stopped when Core is
              halted */
   { "\x10\x21\xe5\x50\x93\x45\x49\xc7\xe5\x4d\x43\xd0", 8, 1 },  /* DBG_TIMER14_STOP: Debug Timer 14 stopped when Core is
              halted */
   { "\x10\x21\xe5\x50\x93\x5c\x8e\x54\xd4\x3d\x00", 9, 1 },  /* DBG_TIM18_STOP: Debug Timer 18 stopped when Core is
              halted */
   { "\x10\x21\xe5\x49\x40\xe5\x4d\x43\xd0", 10, 1 },  /* DBG_RTC_STOP: Debug RTC stopped when Core is
              halted */
   { "\x10\x21\xe5\x5d\x71\x07\x95\x35\x0f\x40", 11, 1 },  /* DBG_WWDG_STOP: Debug Window Wachdog stopped when Core
              is halted */
   { "\x10\x21\xe5\x25\x71\x07\x95\x35\x0f\x40", 12, 1 },  /* DBG_IWDG_STOP: Debug Independent Wachdog stopped when
              Core is halted */
   { "\x25\xd0\xdc\x95\x33\x42\x55\x39\x54\x24\xd1\x4f\x55\x40", 21, 1 },  /* I2C1_SMBUS_TIMEOUT: SMBUS timeout mode stopped when Core is
              halted */
   { "\x25\xd0\xdd\x95\x33\x42\x55\x39\x54\x24\xd1\x4f\x55\x40", 22, 1 },  /* I2C2_SMBUS_TIMEOUT: SMBUS timeout mode stopped when Core is
              halted */
   { "\x10\x21\xe5\x0c\x13\xa5\x4d\x43\xd0", 25, 1 },  /* DBG_CAN_STOP: Debug CAN stopped when core is
              halted */
};

const Field_t DBGMCU_APB2FZ_fields[] = {
   { "\x10\x21\xe5\x50\x93\x5c\x82\x54\xd4\x3d\x00", 2, 1 },  /* DBG_TIM15_STOP: Debug Timer 15 stopped when Core is
              halted */
   { "\x10\x21\xe5\x50\x93\x5c\x86\x54\xd4\x3d\x00", 3, 1 },  /* DBG_TIM16_STOP: Debug Timer 16 stopped when Core is
              halted */
   { "\x10\x21\xe5\x50\x93\x5c\x8a\x54\xd4\x3c", 4, 1 },  /* DBG_TIM17_STO: Debug Timer 17 stopped when Core is
              halted */
   { "\x10\x21\xe5\x50\x93\x5c\x92\x54\xd4\x3d\x00", 5, 1 },  /* DBG_TIM19_STOP: Debug Timer 19 stopped when Core is
              halted */
};

const Register_t DBGMCU_registers[] = {
   {"\x24\x40\xcf\x10\x50", 0, 32, 0, DBGMCU_IDCODE_fields, 2}, /* IDCODE: MCU Device ID Code Register */
   {"\x0d\x20", 4, 32, 0, DBGMCU_CR_fields, 5}, /* CR: Debug MCU Configuration
          Register */
...
const Peripheral_t Peripherals[] = {
   ...
   {"\x55\x30\xa5\x19\x30", 0x40005c00, USB_FS_registers, 13 }, /* USB_FS: Universal serial bus full-speed device
      interface */
   ...
   {"\x4d\x02\x5c", 0x40013000, SPI1_registers, 9 }, /* SPI1: Serial peripheral interface/Inter-IC
      sound */
